...
class VoloAdmin(admin.ModelAdmin):
    list_display = ('codice', 'aeroporto', 'prezzo_unitario', 'ora_partenza', 'ora_arrivo', 'data_partenza', 'data_arrivo', 'km', 'aereo')
    list_filter = ('codice', 'aeroporto', 'prezzo_unitario', 'ora_partenza', 'ora_arrivo', 'data_partenza', 'data_arrivo', 'km', 'aereo')
